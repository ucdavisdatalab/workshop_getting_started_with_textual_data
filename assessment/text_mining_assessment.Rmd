...
2. Document Info
    ...
    **raw** counts.
    b. With that done, you can begin surveying your corpus:
        ...
        + Construct graphs as appropriate to help you in your exploratory work.
...
3. Document Similarity
    ...
    c. Term correlations often provide a helpful way to identify what, exactly, 
    is similar across texts. Subset your tf-idf matrix for your three texts and 
    produce a term correlation matrix from them.
        + **Note:** since you're only working with three texts, you're likely 
        going to have many empty columns in your matrix. If you remove these 
        columns, it'll speed up the process of building the correlation matrix. 
        You can do this with `df.loc[:, (df != 0).any(axis=0)]`, where `df` is 
        your subsetted matrix.
    d. In a few sentences, briefly reflect on these (dis)similarities. If you're 
    familiar with the texts you've chosen, are you surprised by what you've found? 
    Consult the term correlations matrix. Do you notice any highly- or 
    lowly-correlated terms across these documents? What do you make of them?
